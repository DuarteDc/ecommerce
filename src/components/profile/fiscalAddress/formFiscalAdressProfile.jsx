...
export const FormFiscalAddressProfile = () =>{
    ...
    const validationSchema = {
      ...
      tax_system:Yup.object().required("El régimen fiscal es requerido"),
  ...
  const formik = useFormik({
      ...
      onSubmit: (formData) => {
          formData.tax_system = formData.tax_system.value
          formData.address = {
          ...
          if(fiscalAddress){
            dispatch(startUpdateFiscalAddress(formData));
          }else{
            dispatch(startAddFiscalAddress(formData));
          }
