...
const Influencer = () => {
    ...
    return (
        <Layout>
            ...
            />
            <section className=" max-w-[1490px] mx-auto my-20 h-4/5 mb-96 mt-40">
                    ...
                    <div className="lg:col-span-2 lg:pl-20">
                        <form onSubmit={formik.handleSubmit}>
                            <div className="border-[1px] border-solid border-[#e6e6e6] rounded-sm flex items-center mb-10">
                                ...
                                <input type="text" name="fullname" placeholder="Ingresa tu nombre completo" className="w-full h-12 font-Poppins text-[13px] leading-[1.6] text-[#333] pr-[30px] pl-[5px] outline-0" />
                            </div>
                            <div className="border-[1px] border-solid border-[#e6e6e6] rounded-sm flex items-center mb-10">
                                <IconContext.Provider
                                    value={{ className: "text-[25px] text-[#888] w-[15%] " }}
                                ...
                                <input type="email" name="email" placeholder="Ingresa tu enlace de facebook" className="w-full h-12 font-Poppins text-[13px] leading-[1.6] text-[#333] pr-[30px] pl-[5px] outline-0" />
                            </div>
                            <div className="border-[1px] border-solid border-[#e6e6e6] rounded-sm flex items-center mb-10">
                                <IconContext.Provider
                                    value={{ className: "text-[25px] text-[#888] w-[15%] " }}
                                ...
                                <input type="text" name="instagram" placeholder="Ingresa tu enlace de instagram" className="w-full h-12 font-Poppins text-[13px] leading-[1.6] text-[#333] pr-[30px] pl-[5px] outline-0" />
                            </div>
                            <div className="border-[1px] border-solid border-[#e6e6e6] rounded-sm flex items-center mb-10">
                                <IconContext.Provider
                                    value={{ className: "text-[25px] text-[#888] w-[15%] " }}
                                ...
                                <input type="text" name="facebook" placeholder="Ingresa tu enlace de tiktok" className="w-full h-12 font-Poppins text-[13px] leading-[1.6] text-[#333] pr-[30px] pl-[5px] outline-0" />
                            </div>
                            <div className="border-[1px] border-solid border-[#e6e6e6] rounded-sm flex items-center mb-10">
                                <IconContext.Provider
                                    value={{ className: "text-[25px] text-[#888] w-[15%] " }}
                                ...
                                <input type="text" name="tiktok" placeholder="Ingresa tu correo electronico" className="w-full h-12 font-Poppins text-[13px] leading-[1.6] text-[#333] pr-[30px] pl-[5px] outline-0" />
                            </div>
                            <div>
                                <button
                                    type="submit"
